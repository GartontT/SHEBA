...
;  votable optative (stilts)x
stilts_command = 'ext_lib/stilts tcopy '+file_out+'.csv ifmt=csv '+file_out+'00.votable ofmt=votable'
stilts_change  = 'ext_lib/stilts tpipe cmd=@'+model+'_stilts_script '+file_out+'00.votable ofmt=votable out='+file_out+'.votable'
...
join_all = 'cat webtemplates/'+model+'_index_header.html '+file_input+' '+file_output+' '+file_cxs +' webtemplates/'+model+'_index_footer.html > '+ file_out
spawn,join_all
